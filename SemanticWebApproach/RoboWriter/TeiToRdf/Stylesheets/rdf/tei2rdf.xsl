...
<!DOCTYPE XSL:stylesheet [
        <!ELEMENT XSL:stylesheet (XSL:import|XSL:param|XSL:template)*>
        <!ATTLIST XSL:stylesheet
                xmlns:XSL CDATA #REQUIRED
                version CDATA #REQUIRED
                xpath-default-namespace CDATA #REQUIRED>
        <!ELEMENT XSL:import (#PCDATA)>
        <!ATTLIST XSL:import
                href CDATA #REQUIRED>
        <!ELEMENT XSL:param (#PCDATA)>
        <!ATTLIST XSL:param
                name CDATA #REQUIRED>
        <!ELEMENT XSL:template (XSL:apply-templates|XSL:call-template|E55_Type)*>
        ...
        <!ELEMENT XSL:call-template (#PCDATA)>
        <!ATTLIST XSL:call-template
                name CDATA #REQUIRED>
        <!ELEMENT E55_Type (label|P127_has_broader_term)*>
        <!ATTLIST E55_Type
        ...
        <!ATTLIST label
                xmlns CDATA #REQUIRED>
        <!ELEMENT P127_has_broader_term (#PCDATA)>
        <!ATTLIST P127_has_broader_term

...
import logging
from AIML.CAML.semiotics.quepy.quepy import settings
from AIML.CAML.semiotics.quepy.quepy.semantics import IsRelatedTo
from AIML.CAML.semiotics.quepy.quepy.encodingpolicy import assert_valid_encoding
from AIML.CAML.semiotics.quepy.quepy.expression import isnode
...
def expression_to_dot(e):
    from AIML.CAML.semiotics.quepy.quepy.semantic_utils import dot_type, dot_keyword, dot_arc
...
def expression_to_sparql(e, full=False):
    from AIML.CAML.semiotics.quepy.quepy.semantic_utils import triple
    template = u"{preamble}\n" +\
